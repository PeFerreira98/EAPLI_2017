...
//    private static final int NUTRICIONAL_PROFILE_OPTION = 2;
...
//        add(new MenuItem(NUTRICIONAL_PROFILE_OPTION, "Register Nutricional Profile", new RegisterNutricionalProfileAction()));
